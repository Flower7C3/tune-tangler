      ...
      ExpansionTile(
        ...
        children: [
          _uiHelper.buildRichText(_trans.helpScreenMessageDetailsScreenContent, data: {
            ...
            'playbackMode': AppIcon.trackPlaybackMode,
            'playbackVolume': AppIcon.trackPlaybackVolume,
            'playbackBalance': AppIcon.trackPlaybackBalance,
            'playbackSpeed': AppIcon.trackPlaybackSpeed,
            'trackName': AppIcon.trackTitle,
            'keyboardKey': AppIcon.trackKeyboardKey,
            'import': AppIcon.trackRecordingImport,
            'share': AppIcon.trackRecordingShare,
            'delete': AppIcon.deleteForever,
          }),
        ],
      ),
      ExpansionTile(
        ...
        children: [
          _uiHelper.buildRichText(_trans.helpScreenMessageSettingsInfo, data: {
            'codec': AppIcon.recordingAudioEncoder,
            'sampleRate': AppIcon.recordingSampleRate,
            'bitRate': AppIcon.recordingBitRate,
            'audioMode': AppIcon.recordingAudioMode,
            'gain': AppIcon.recordingAudioGain,
            'echoCancel': AppIcon.recordingEchoCancel,
            'noiseSuppress': AppIcon.recordingNoiseSuppress,
          }),
          ListTile(
