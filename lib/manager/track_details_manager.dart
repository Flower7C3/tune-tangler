...
class TrackDetailsManager {
        ...
        builder: (context) => LayoutBuilder(
            builder: (context, BoxConstraints constraints) =>
                DraggableScrollableSheet(
                    expand: false,
                    initialChildSize:
                        (640 / constraints.maxHeight).clamp(0.3, 0.9),
  ...
  List<Widget> _trackDetailsTitle(Track track) => [
        ...
        ValueListenableBuilder(
            valueListenable:
                CombinedNotifier([track.state, track.name, track.keyboardKey]),
  ...
  Widget _trackDetailsInfoBox(Track track) => _uiHelper.trackDetailsBox([
        if (track.audioSourceIcon != null && track.path != null)
          _uiHelper.statusIconTile(
              track.audioSourceIcon!, path.basename(track.path.toString()),
        ...
        ValueListenableBuilder<Duration>(
            ...
            builder: (context, time, child) =>
                track.duration.value.inMilliseconds > 0
                    ? _uiHelper.statusIconTile(
        ...
        if (track.audioEncoder != null)
          _uiHelper.statusIconTile(
              ...
              AppGlobalConfig.recordingAudioEncoder
                  .translate(track.audioEncoder, trans: _trans),
              iconSize: Theme.of(_context).textTheme.bodyLarge!.fontSize! *
                  UIHelper.iconSizeMultiplier,
              fontSize: Theme.of(_context).textTheme.bodyLarge!.fontSize!),
        if (track.sampleRate != null)
          _uiHelper.statusIconTile(
              ...
              _trans.recordingSampleRateValue(AppGlobalConfig
                  .recordingSampleRate
                  .format(track.sampleRate?.toDouble())),
              iconSize: Theme.of(_context).textTheme.bodyLarge!.fontSize! *
                  UIHelper.iconSizeMultiplier,
              fontSize: Theme.of(_context).textTheme.bodyLarge!.fontSize!),
        if (track.bitRate != null)
          _uiHelper.statusIconTile(
              ...
              _trans.recordingBitRateValue(AppGlobalConfig.recordingBitRate
                  .format(track.bitRate?.toDouble())),
              iconSize: Theme.of(_context).textTheme.bodyLarge!.fontSize! *
                  UIHelper.iconSizeMultiplier,
              fontSize: Theme.of(_context).textTheme.bodyLarge!.fontSize!),
        // Sekcja ostrzeżeń
      ...
      _uiHelper.trackDetailsBox([
        ListTile(
          ...
          leading: _uiHelper.mediaPlayerButton(
            ...
            onPressed: () {
              track.setPlaybackVolume((track.playbackVolume.value ==
          ...
          trailing: Text(AppGlobalConfig.trackPlaybackVolume
              .format(track.playbackVolume.value)),
        ...
        Slider(
          ...
          label: AppGlobalConfig.trackPlaybackVolume
              .format(track.playbackVolume.value),
  ...
  Widget _trackDetailsPlaybackBalanceControl(Track track) =>
      _uiHelper.trackDetailsBox([
        ListTile(
          visualDensity: VisualDensity.compact,
          style: ListTileStyle.drawer,
          leading: _uiHelper.mediaPlayerButton(
            AppGlobalConfig.trackPlaybackBalance
                .icon(track.playbackBalance.value),
          ...
          trailing: Text(AppGlobalConfig.trackPlaybackBalance
              .format(track.playbackBalance.value)),
        ...
        SliderTheme(
          ...
          child: Slider(
            ...
            label: AppGlobalConfig.trackPlaybackBalance
                .translate(track.playbackBalance.value, trans: _trans),
  ...
  Widget _trackDetailsPlaybackSpeedControl(Track track) =>
      _uiHelper.trackDetailsBox([
        ListTile(
          ...
          trailing: Text(AppGlobalConfig.trackPlaybackSpeed
              .format(track.playbackSpeed.value)),
        ...
        Slider(
          ...
          label: AppGlobalConfig.trackPlaybackSpeed
              .format(track.playbackSpeed.value),
  ...
  Widget _trackDetailsProgress(Track track) => _uiHelper.trackDetailsBox([
        ...
        _uiHelper.trackDetailsLine(_trackDetailsProgressText(track),
  ...
  Widget _trackDetailsProgressSlider(Track track) => ValueListenableBuilder(
      ...
      builder: (context, _, __) => Expanded(
          child: Slider(
              ...
              onChanged: (value) {
                if (track.playbackStartAtPosition.value.inMilliseconds <=
                        value &&
  ...
  List<Widget> _trackDetailsProgressText(Track track) => [
        ValueListenableBuilder(
            valueListenable:
                CombinedNotifier([track.positionAfterCut, track.playbackSpeed]),
        ...
        ValueListenableBuilder(
            valueListenable:
                CombinedNotifier([track.durationAfterCut, track.playbackSpeed]),
            builder: (context, _, __) => _uiHelper.statusIconRow(
                  AppIcon.trackDuration,
                  _uiHelper.formatTime(
  ...
  Widget _trackDetailsClip(Track track) => _uiHelper.trackDetailsBox([
        ...
        _uiHelper.trackDetailsLine(_trackDetailsClipText(track),
            mainAxisAlignment: MainAxisAlignment.spaceAround),
        _uiHelper.trackDetailsLine(_trackDetailsClipButtons(track),
            mainAxisAlignment: MainAxisAlignment.spaceAround),
      ]);
  ...
  List<Widget> _trackDetailsClipText(Track track) => [
        ValueListenableBuilder(
            valueListenable: CombinedNotifier(
                [track.playbackStartAtPosition, track.playbackSpeed]),
            builder: (context, _, __) => _uiHelper.statusIconRow(
        ...
        ValueListenableBuilder(
            valueListenable: CombinedNotifier(
                [track.playbackEndAtPosition, track.playbackSpeed]),
            builder: (context, _, __) => _uiHelper.statusIconRow(
  ...
  List<Widget> _trackDetailsClipButtons(Track track) => [
        ValueListenableBuilder(
            valueListenable: CombinedNotifier(
                [track.playbackStartAtPosition, track.playbackEndAtPosition]),
                  ...
                  children: [
                    _uiHelper.mediaPlayerButton(
                      ...
                      iconSize:
                          Theme.of(_context).textTheme.bodyLarge!.fontSize!,
                      boxSize:
                          Theme.of(_context).textTheme.bodyLarge!.fontSize! * 2,
                    ),
                    _uiHelper.mediaPlayerButton(
                      ...
                      onPressed:
                          (track.playbackStartAtPosition.value.inMilliseconds ==
                                  0)
                              ? null
                              : () => track.changePlaybackStartAtPosition((track
                                              .playbackStartAtPosition
                                              .value
                                              .inMilliseconds +
                                          100 >
                                      track.playbackEndAtPosition.value
                                          .inMilliseconds)
                                  ? -10
                                  : -100),
                      iconSize:
                    ...
                    _uiHelper.mediaPlayerButton(
                      ...
                      onPressed: (track.playbackStartAtPosition.value
                                  .inMilliseconds >
                              track.playbackEndAtPosition.value.inMilliseconds)
                          ? null
                          : () => track.changePlaybackStartAtPosition((track
            ...
            builder: (context, _, __) => Row(
                  children: [
                    _uiHelper.mediaPlayerButton(
                      ...
                      onPressed:
                          (track.playbackEndAtPosition.value.inMilliseconds <
                                  track.playbackStartAtPosition.value
                                      .inMilliseconds)
                              ? null
                              : () => track.changePlaybackEndAtPosition((track
  ...
  List<PopupMenuEntry<TrackMenuItem>> _trackMenuItems(
          Track track, TrackState state) =>
      [
        if (state != TrackState.recording)
          _uiHelper.popupMenuItem<TrackMenuItem>(TrackMenuItem.nameChange,
              AppIcon.trackName, _trans.trackNameChange),
        if (state != TrackState.recording)
        ...
        if (state != TrackState.empty && state != TrackState.recording)
          _uiHelper.popupMenuItem<TrackMenuItem>(TrackMenuItem.recordingMove,
              AppIcon.trackRecordingMove, _trans.trackRecordingMove),
        if (state != TrackState.empty && state != TrackState.recording)
          _uiHelper.popupMenuItem<TrackMenuItem>(TrackMenuItem.recordingDelete,
              AppIcon.deleteForever, _trans.trackRecordingDelete),
      ];
  ...
  void _trackMenuItemSelected(Track track, TrackMenuItem selection) async {
    switch (selection) {
        ...
        showDialog(
            ...
            builder: (BuildContext context) => StatefulBuilder(
                builder: (context, setDialogState) => AlertDialog(
                        title: _uiHelper.statusIconTile(AppIcon.trackName,
                        ...
                        content: Column(
                            ...
                            children: [
                              Text(
                                  _trans.trackNameChangeInfo(track.name.value)),
                              SizedBox(
                        ...
                        actions: <Widget>[
                          if (selectedEmoji != track.id.toString())
                            _uiHelper.errorButton(
                              ...
                              _uiHelper.toast(
                                  _trans.trackNameChangeSuccess(
                                      track.id.toString()),
                                  icon: AppIcon.trackName);
                            }),
                          _uiHelper.simpleButton(_trans.buttonCancel,
                              () => Navigator.pop(context, 'cancel')),
                          _uiHelper.primaryButton(
                              _trans.buttonSaveTo(selectedEmoji), () {
      ...
      case TrackMenuItem.keyboardKeyChange:
        _uiHelper.alertDialog(AppIcon.trackKeyboardKey,
      ...
      case TrackMenuItem.recordingMove:
        _uiHelper.alertDialog(AppIcon.trackRecordingMove,
            ...
            contentWidget: _uiHelper.gridBuilder(
                ...
                itemBuilder: (context, index) {
                  Track loopTrack =
                      _trackRepository.allTracks().toList().elementAt(index);
                  return OutlinedButton(
                      style: OutlinedButton.styleFrom(
                        padding: EdgeInsets.zero,
                        shape: RoundedRectangleBorder(
