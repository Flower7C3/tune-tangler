  ...
  List<PopupMenuEntry<dynamic>> _rowMenuItems(int rowIndex) => <PopupMenuEntry<dynamic>>[
        _uiHelper.popupMenuButton(RowMenuItem.playbackModeSet, AppIcon.trackPlaybackMode, _trans.rowTracksPlaybackModeSet,
            ...
            onSelected: (selection) {
              _trackRepository.setTracksPlaybackMode(_trackRepository.rowTracks(rowIndex), selection);
              _uiHelper.toast(
        ...
        _uiHelper.popupMenuButton(RowMenuItem.playbackVolumeSet, AppIcon.trackPlaybackVolume, _trans.rowTracksPlaybackVolumeSet,
            ...
            onSelected: (selection) {
              _trackRepository.setTracksPlaybackVolume(_trackRepository.rowTracks(rowIndex), selection);
              _uiHelper.toast(
        ...
        _uiHelper.popupMenuButton(RowMenuItem.playbackBalanceSet, AppIcon.trackPlaybackBalance, _trans.rowTracksPlaybackBalanceSet,
            ...
            onSelected: (selection) {
              _trackRepository.setTracksPlaybackBalance(_trackRepository.rowTracks(rowIndex), selection);
              _uiHelper.toast(
        ...
        _uiHelper.popupMenuButton(RowMenuItem.playbackSpeedSet, AppIcon.trackPlaybackSpeed, _trans.rowTracksPlaybackSpeedSet,
            ...
            onSelected: (selection) {
              _trackRepository.setTracksPlaybackSpeed(_trackRepository.rowTracks(rowIndex), selection);
              _uiHelper.toast(_trans.rowTracksPlaybackSpeedSuccessSet(TrackRow.name(rowIndex), AppGlobalConfig.trackPlaybackSpeed.format(selection)),
                  icon: AppIcon.trackPlaybackSpeed);
              Navigator.pop(_context);
            }),
    ...
    switch (selection) {
      case RowMenuItem.playbackStartAtPositionReset:
        _uiHelper.alertDialogReset(
          ...
          _trans.buttonYes,
          () {
            _trackRepository.resetTracksPlaybackStartAtPosition(_trackRepository.rowTracks(rowIndex));
      ...
      case RowMenuItem.playbackEndAtPositionReset:
        _uiHelper.alertDialogReset(
          ...
          _trans.buttonYes,
          () {
            _trackRepository.resetTracksPlaybackEndAtPosition(_trackRepository.rowTracks(rowIndex));
            return _trans.rowTracksPlaybackEndAtPositionResetSuccess(TrackRow.name(rowIndex));
          },
        );
        break;
      case RowMenuItem.recordingsDelete:
        _uiHelper.alertDialog(AppIcon.deleteForever, _trans.rowTracksRecordingsDeleteTitle,
