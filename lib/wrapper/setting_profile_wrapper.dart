...
class SettingProfileWrapper {
    ...
    ExpansionTile(
      ...
      children: [
        ...
        _tile(
          ...
          _trans.recordingAudioEncoderValue(
            AppGlobalConfig.recordingAudioEncoder.format(
        ...
        _tile(
          ...
          _trans.recordingBitRateValue(
            AppGlobalConfig.recordingBitRate.format(
              settingsProfile.recordingBitRate,
            ),
          ),
        ),
        _tile(
          AppIcon.recordingAudioMode,
          _trans.recordingAudioModeValue(
            AppGlobalConfig.recordingAudioMode.translate(
        ...
        _tile(
          ...
          _trans.recordingAutoGainValue(
            AppGlobalConfig.recordingAutoGain.translate(
        ...
        _tile(
          ...
          _trans.recordingEchoCancelValue(
            AppGlobalConfig.recordingEchoCancel.translate(
        ...
        _tile(
          ...
          _trans.recordingNoiseSuppressValue(
            AppGlobalConfig.recordingNoiseSuppress.translate(
    ...
    ExpansionTile(
      ...
      children: [
        ...
        _tile(
          ...
          _trans.screenThemeModeValue(
            AppGlobalConfig.screenThemeMode.translate(
              settingsProfile.themeMode,
              trans: _trans,
            ),
          ),
        ),
        _tile(
          ...
          _trans.screenThemeColorValue(
            AppGlobalConfig.userInterfaceColor.translate(
              settingsProfile.themeSeedColor,
              trans: _trans,
            ),
          ),
        ),
        _tile(
          ...
          _trans.keepScreenOnValue(
            AppGlobalConfig.keepScreenOn.translate(
  ...
  void create() {
    ...
    settingsProfile.recordingInputDevice = _settings.getConfig(
      AppConfigFieldKey.recordingInputDevice,
    );
    settingsProfile.recordingAudioEncoder = _settings.getConfig(
      AppConfigFieldKey.recordingAudioEncoder,
    );
    settingsProfile.recordingSampleRate = _settings.getConfig(
      AppConfigFieldKey.recordingSampleRate,
    );
    settingsProfile.recordingBitRate = _settings.getConfig(
      AppConfigFieldKey.recordingBitRate,
    );
    settingsProfile.recordingAudioModeStereo = _settings.getConfig(
      AppConfigFieldKey.recordingAudioModeStereo,
    );
    settingsProfile.recordingAutoGain = _settings.getConfig(
      AppConfigFieldKey.recordingAutoGain,
    );
    settingsProfile.recordingEchoCancel = _settings.getConfig(
      AppConfigFieldKey.recordingEchoCancel,
    );
    settingsProfile.recordingNoiseSuppress = _settings.getConfig(
      AppConfigFieldKey.recordingNoiseSuppress,
    );
    settingsProfile.locale = _settings.getConfig(AppConfigFieldKey.locale);
    settingsProfile.themeMode = _settings.getConfig(
      AppConfigFieldKey.themeMode,
    );
    settingsProfile.themeSeedColor = _settings.getConfig(
    ...
    _uiHelper.toast(
      _trans.settingsProfileCreated,
      icon: AppIcon.settingsProfiles,
    );
  }
  ...
  Map<String, dynamic> _data(SettingsProfile item) => {
    ...
    'recordingSampleRateValue': AppGlobalConfig.recordingSampleRate.format(
      item.recordingSampleRate,
    ),
    'recordingBitRateIcon': AppIcon.recordingBitRate,
    'recordingBitRateValue': AppGlobalConfig.recordingBitRate.format(
      item.recordingBitRate,
    ),
    'recordingAudioModeIcon': item.recordingAudioModeStereo
        ? AppIcon.recordingAudioModeStereo
        : AppIcon.recordingAudioModeMono,
    'recordingAutoGainIcon': item.recordingAutoGain
        ? AppIcon.recordingAutoGain
        : '',
    'recordingEchoCancelIcon': item.recordingEchoCancel
        ? AppIcon.recordingEchoCancel
        : '',
    ...
    'themeSeedColorName': AppGlobalConfig.userInterfaceColor.translate(
      item.themeSeedColor,
      trans: _trans,
    ),
