...
### 4) Audio effects (deferred — needs DSP) <a name="audio-effects-deferred"></a>
...
### 7) Playback: audioplayers vs just_audio (analysis + plan) <a name="playback-stack"></a>
