...
- CI on `main`: tests + F-Droid checklist (APK/AAB disabled in default workflow; separate APK/AAB build: `release-apk-aab-google-play.yml`); historical auto bump + tag:  
