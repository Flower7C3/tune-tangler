...
- [⚙️ Post-install setup](#post-install-setup)
...
Complete this document **once** when joining the project or on a new workstation. For a shorter path, use [Quick start — one-time configuration](QUICKSTART.md#one-time-configuration) (`make dev-setup`), then return here for Android/iOS details.
...
## ⚙️ Post-install setup <a name="post-install-setup"></a>
...
### ☑️ Checklist <a name="checklist"></a>
...
- **[Development guide](../../README.md#one-time-configuration)**
- **[Quick start](QUICKSTART.md#one-time-configuration)**
- **[Workflows — One-time configuration](WORKFLOWS.md#one-time-configuration)** — CI secrets
