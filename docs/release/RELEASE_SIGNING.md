...
- [Problem](#problem)
- [Solution](#solution)
- [One-time setup](#one-time-configuration-steps)
  - [Prepare configuration](#prepare-configuration)
  - [Generate keystore](#generate-keystore)
  - [Configure GitHub secrets](#prepare-github-secrets)
...
### 1. Prepare configuration <a name="prepare-configuration"></a>
...
### 2. Generate keystore <a name="generate-keystore"></a>
...
### 3. Configure GitHub secrets <a name="prepare-github-secrets"></a>
