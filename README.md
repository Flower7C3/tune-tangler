...
- **[📦 F-Droid](docs/release/FDROID.md)** — Actions workflow updates a **fixed-name branch** on your fdroiddata fork (link in run summary); merge request to upstream is manual in GitLab + templates in `.github/templates/fdroid/`
