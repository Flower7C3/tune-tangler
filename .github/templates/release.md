...
- [arm64-v8a](https://github.com/{{ GITHUB_REPOSITORY }}/releases/download/{{ REPOSITORY_TAG_NAME }}/tune-tangler-{{ APP_BUILD_VERSION }}-arm64-v8a.apk) – modern 64-bit ARM architecture (this probably what You want)
...
> Do not know what select? See [installation manual](https://github.com/{{ GITHUB_REPOSITORY }}/blob/main/docs/INSTALLATION.md).
